...
var PROGRESS_MAX_SIZE = Math.floor(100 / 8);
var PROGRESS_INCOMPLETE = ['▏', '▎', '▍', '▌', '▋', '▊', '▉'];
...
function getStatusMessage() {
    ...
    var result = Promise.all(singleStatusArr)
        ...
        if (statusArr && statusArr.length > 0) {
            var message;
            statusArr.sort(function (a, b) { return (a.dlDetails && b.dlDetails) ? (a.dlDetails.startTime - b.dlDetails.startTime) : 1; })
